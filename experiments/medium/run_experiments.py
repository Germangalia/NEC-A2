#!/usr/bin/env python3
"""
GA experiments for JSSP - Medium Dataset (ft10).
"""
...
def main():
    ...
    # Setup experiment
    results_dir, timestamp, log_file, logger, original_stdout = setup_experiment('medium', 'ga')
    ...
    print(f"{'='*80}")
    generate_ga_evolution_plots(all_results, all_histories, results_dir, 'ft10', timestamp)
