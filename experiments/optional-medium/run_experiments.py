#!/usr/bin/env python3
"""
Optional Algorithm (Simulated Annealing) experiments for JSSP - Medium Dataset.
"""
...
def main():
    ...
    results_dir = os.path.join(project_root, 'results/optional-algorithm/medium')
    ...
    print("="*80)
    print(f"Optional Algorithm Experiments Log - Medium Dataset (ft10) - {timestamp}")
    print("="*80)
    ...
    plt.tight_layout()
    plot_file = os.path.join(results_dir, f'sa_evolution_plots_ft10_{timestamp}.png')
    ...
    ax.set_title('Simulated Annealing: Comparison of All Experiments (ft10)', fontsize=16, fontweight='bold')
    ax.grid(True, alpha=0.3)
    ax.legend(loc='upper right', fontsize=10)
    
    plt.tight_layout()
    comparison_file = os.path.join(results_dir, f'sa_evolution_comparison_ft10_{timestamp}.png')
