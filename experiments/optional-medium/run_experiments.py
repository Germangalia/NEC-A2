#!/usr/bin/env python3
"""
Optional Algorithm (Simulated Annealing) experiments for JSSP - Medium Dataset (ft10).
"""
...
def main():
    ...
    # Setup experiment
    results_dir, timestamp, log_file, logger, original_stdout = setup_experiment('optional-medium', 'sa')
    ...
    print(f"{'='*80}")
    generate_sa_evolution_plots(all_results, results_dir, 'ft10', timestamp)
